 ...
 */
 ...
 int main(int argc, char *argv[]){
   ...
   /*-------------------------------------------------------------------------
    * Collect indices for FD formulas in global numbering, this will avoid
    * many calls to the g2l and l2g functions at the cost of storing 5*nl long
    * integer datas.
    *-------------------------------------------------------------------------*/
